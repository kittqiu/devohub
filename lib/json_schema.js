...
var schemas = {
	...
	editTask: {
		...
		properties: {
			...
			milestone:PROPERTY.MINI_INTEGER
		},
		required:['name', 'executor_id', 'manager_id', 'plan_duration', 'plan_start_time', 'plan_end_time', 'automode', 'difficulty', 'details', 'relyTo', 'milestone']
	},
	product:{
		type: 'object',
		properties: {
	...
	project:{
		...
		properties: {
			...
			security_level:PROPERTY.MINI_INTEGER
		},
		required:['name', 'start_time', 'end_time', 'master_id', 'details','status','security_level']
	},
	project_create:{
		type: 'object',
		properties: {
	...
	simpleTask: {
		...
		required:['name', 'parent', 'executor', 'duration', 'start_time', 'end_time', 'automode', 'relyTo', 'difficulty', 'details','milestone']
	},
	taskFlow: {
		type: 'object',
		properties: {

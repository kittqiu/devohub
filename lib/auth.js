...
function _generate_login_password( username, passwd, salt ){
	return crypto.createHash('sha1').update( passwd + salt + username ).digest('hex');
}
...
function loginRequired(context){
 ...
 module.exports = {
 	generate_login_password: _generate_login_password,
